			...
			<!-- END PAGE CONTENT-->
				...
				<form role="form" method="POST"  >
					<div class="form-body">
						...
						<a href="<?php echo $this->url->get('cmcategory'); ?>" type="button" class="btn default">Хаах</a>
			...
			<div class="modal-body">
				<form role="form" >
					<div class="form-body">
									<div class="form-group">
								            <label>Категори</label>
								            <input type="text" id="categoryInput" class="form-control" placeholder=" Категори">
									</div>
									<div class="form-group" id="correspondentList">
										<label class=>Харъяалагдах категори</label>
									...
									<div class="form-group">
									            <label> Хэрэглэгчийн хэсэгт харагдах эсэх </label>
                                                                                    <input type="checkbox" id="is_show_list">
									</div>
					</div>
...
<?php echo $this->tag->javascriptInclude('assets/admin/pages/scripts/form-validation.js'); ?>
